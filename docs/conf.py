...
project = 'uos activpal'
copyright = '2018, R Broadley'
author = 'R Broadley'
...
htmlhelp_basename = 'uosactivpaldoc'
...
latex_documents = [
    (master_doc, 'uosactivpal.tex', 'uos activpal Documentation',
     'R Broadley', 'manual'),
]
...
man_pages = [
    (master_doc, 'uosactivpal', 'uos activpal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'uosactivpal', 'uos activpal Documentation',
     author, 'uosactivpal', 'One line description of project.',
     'Miscellaneous'),
]
